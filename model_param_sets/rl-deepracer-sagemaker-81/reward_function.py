...
class RunState:
    ...
    def additive_reward(self):
        return (math.fsum(self.additive_factors) + self.progress_advancement) / len(self.additive_factors)
    ...
    def center_line_reward(self):
        ...
        return (mod_distance_factor - 0.5) * 2
    ...
    def _set_derived_inputs(self, max_progress_advancement):
        self.progress_val = (self.progress * .01)
